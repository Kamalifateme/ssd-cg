...
<html lang="en">
	...
	<body>
		...
		<div class="container">
			...
			<div class="row">
			<h2>Thank you for Purchasing Freelancer Office </h2>
				...
				<?php
				//$password =
				// '$P$B4Sy4AFtkr1c/HYXoqd6lFB2tOqDib.';
				// == admin
			...
			mysql_query("UPDATE fx_config SET value = '$url' WHERE value = '%BaseURL%'") or print(mysql_error());
			mysql_query("UPDATE fx_config SET value = '$email' WHERE value = '%CompanyEmail%'") or print(mysql_error());
							...
							$db_file = str_replace('%dbprefix%', 'fx_', $db_file);
							...
							echo '<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert">×</button> <i class="fa fa-check-circle"></i> Freelancer Office has been installed successfully. You may access the administration control panel at <a href="' . $url . '">' . $url . '</a> using the admin email/username and password <b>admin</b>';				
	...
	<form action="index.php" method="post" class="bs-example form-horizontal">
		<div class="form-group">
			...
			<div class="col-lg-10">
				...
				<span class="help-block m-b-none">The Base URL of the System <strong>Ending with a forward slash</strong>
				</span>
			</div>
		</div>
		<div class="form-group">
