	...
	<div class="modal-content">
		...
		<div class="modal-body">
			...
			<input type="hidden" name="invoice_id" value="<?=$invoice_id?>">
				...
				<div class="form-group">
				<label class="col-lg-4 control-label"><?=lang('amount')?> (<?=$this -> applib -> get_any_field('invoices', array('inv_id' => $invoice_id), 'currency')?>) <span class="text-danger">*</span></label>
				<div class="col-lg-8">
					<input type="text" class="form-control" value="<?=number_format($this -> applib -> calculate('invoice_due',$invoice_id),2,config_item('decimal_separator'),config_item('thousand_separator'))?>" name="amount">
				</div>
				</div>
