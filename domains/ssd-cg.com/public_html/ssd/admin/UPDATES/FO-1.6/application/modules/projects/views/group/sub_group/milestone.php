...
<ul class="list-group no-radius">
    <li class="list-group-item">
      <span class="pull-right"><?=$m->milestone_name?> </span><?=lang('milestone_name')?></li>
    <li class="list-group-item">
      <span class="pull-right"><?=$this -> applib->get_any_field('projects',array('project_id'=>$m->project),'project_title');?></span><?=lang('project')?></li>
...
<ul class="list-group no-radius">
     <li class="list-group-item">
      <span class="pull-right"><?=$m->start_date?></span><?=lang('start_date')?></li>
    <li class="list-group-item">
