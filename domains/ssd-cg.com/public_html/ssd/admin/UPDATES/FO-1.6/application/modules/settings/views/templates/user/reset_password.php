...
echo form_open('settings/templates?settings=templates&group=user&email=reset_password', $attributes); ?>
			<input type="hidden" name="email_group" value="reset_password">
			<input type="hidden" name="return_url" value="<?=base_url()?>settings/?settings=templates&group=user&email=reset_password">
