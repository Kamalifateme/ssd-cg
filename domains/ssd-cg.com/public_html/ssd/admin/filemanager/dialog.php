...
<html xmlns="https://www.w3.org/1999/xhtml">
    ...
    @font-face {
 	...
 	src: url('fonts/BKoodakBold.eot?#') format('eot'),  /* IE6â€“8 */
       ...
       url('font/BKoodakBold.ttf') format('truetype');  /* Saf3â€”5, Chrome4+, FF3.5, Opera 10+ */
	}
    </style>
    
    </head>
    
    <body style="font-family: BKoodakBold, Arial, Helvetica, sans-serif;">
...
<div class="navbar navbar-fixed-top">
    <div class="navbar-inner">
	    ...
	    <div class="brand"><?php echo lang_Toolbar; ?> <img src="img/viwe.png" > </div>
