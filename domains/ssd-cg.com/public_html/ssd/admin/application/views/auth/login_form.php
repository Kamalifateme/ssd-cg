...
<div id="content" class="animated fadeInUp log100">

		<div class="container aside-xxl">
		<!--  <a class="navbar-brand block bg-light" href="<?=base_url()?>"><?=$this->config->item('company_name')?></a> --> 
		 <div class="panel panel-default zzz" style="background-color:#fff;border: 1px #d9dee0 solid;border-radius:5px;">
	...
	<div class="checkbox">
			...
			<button type="submit" class="btn btn-primary">ورود به صفحه مدیریتی</button>
