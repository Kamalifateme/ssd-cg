...
<html lang="en" class="app">
  <head>
    ...
    <link rel="stylesheet" href="<?=base_url()?>resource/css/app.v3.css" type="text/css" />
    <link rel="stylesheet" href="<?=base_url()?>resource/css/app.v4.css" type="text/css" />
    <link rel="stylesheet" href="<?=base_url()?>resource/css/font-awesome.css" type="text/css" />
	<link rel="stylesheet" href="<?=base_url()?>resource/css/simple-line-icons/simple-line-icons.min.css" type="text/css" />
	...
	<link rel='stylesheet' href='<?=base_url()?>resource/js/fullcalendar/fullcalendar.css' />
	<link rel='stylesheet' href='<?=base_url()?>resource/js/fullcalendar/jquery.qtip.css' />
    <link rel="stylesheet" href="<?=base_url()?>resource/js/datepicker/bootstrap-timepicker.min.css" type="text/css" cache="false" />
    <link rel="stylesheet" href="<?=base_url()?>resource/js/datepicker/clockface.css" type="text/css" cache="false" />
    <link rel="stylesheet" href="<?=base_url()?>resource/css/<?=$this->config->item('sidebar_theme2')?>" type="text/css" cache="false" />
	<link rel="stylesheet" type="text/css" href="<?=base_url()?>resource/js/source/jquery.fancybox.css?v=2.1.4" media="screen" />
    <link rel="stylesheet" href="<?=base_url()?>resource/css/ImageSelect.css" type="text/css" cache="false" />
	...
	<link rel="stylesheet" href="<?=base_url()?>resource/js/dist/summernote.css">
    <?php } ?>
    <?php
    ...
    <link rel="stylesheet" href="<?=base_url()?>resource/js/datatables/datatables.css" type="text/css" cache="false" />
        <link rel="stylesheet" href="<?=base_url()?>resource/js/datepicker/bootstrap-datepicker.css" type="text/css" cache="false" />
  ...
  <body>
    <section class="vbox">
	  ...
	  <script src="<?=base_url()?>resource/js/jquery-migrate-1.2.1.min.js" type="text/javascript"></script>
