<div class="modal-dialog animated fadeInDownBig " >
	...
	<div class="modal-content modal-content-one">
		...
		<button type="button" class="close" data-dismiss="modal">&times;</button> <h4 class="modal-title"><?=lang('face')?></h4>
		</div>
		<style>
.datepicker{z-index:99999 !important;}
          ...
          echo form_open(base_url().'drug/add_face',$attributes); ?>
		...
		<button type="submit" class="btn btn-success"><?=lang('save_as_face')?></button>
		</form>
		</div>
		</div>
	</div>
