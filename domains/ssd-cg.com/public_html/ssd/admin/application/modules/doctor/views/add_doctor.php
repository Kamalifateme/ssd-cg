...
<section class="vbox"> <section class="scrollable padder">
	<ul class="breadcrumb no-border no-radius b-b b-light pull-in ">
		...
		<li class="active">
		<a href="<?=base_url()?>doctor/add_doctor"><?=lang('insert_doctor')?>
		</a>
		</li>
	</ul>
	...
	<section class="panel">
			...
			<header class="panel-heading"> <i class="fa fa-navicon"></i> <?=lang('insert_doctor')?> </header>
			<?php 
						 $attributes = array('class' => 'bs-example form-horizontal');
             echo form_open(base_url().'doctor/add_doctor',$attributes); ?>
				...
				<div class="col-lg-12">
					<input type="text" class="form-control"  name="takh"    required >
				</div>
				</div>
