...
<section class="vbox"> <section class="scrollable padder">
	<ul class="breadcrumb no-border no-radius b-b b-light pull-in ">
		...
		<li class="active">
		<a href="<?=base_url()?>edit_doctor"><?=lang('update_doctor')?>
		</a>
		</li>
	</ul>
	...
	<section class="panel">
			...
			<header class="panel-heading"> <i class="fa fa-navicon"></i> <?=lang('update_doctor')?> </header>
						<?php
				if (!empty($doctors)) {
			...
			<?php 
             ...
             echo form_open(base_url().'doctor/edit_doctor',$attributes); ?>
			 
			    <?php $a=lang('error_fill');
				 ?>
				<div class="form-group col-lg-12">
					<label class="col-lg-12 control-label"><?=lang('doctor')?> <span class="text-danger">*</span></label>
				<div class="col-lg-12">
				...
				<div class="col-lg-12">
					<input type="text" class="form-control" value="<?=$doctor->url?>"  name="url"    required >
				</div>
				</div>

								<div class="form-group col-lg-12">
					<label class="col-lg-12 control-label"><?=lang('specialty')?> <span class="text-danger">*</span></label>
				<div class="col-lg-12">
					<input type="text" class="form-control" value="<?=$doctor->takh?>"  name="takh"    required >
				</div>
				</div>
                ...
                <input type="text" name="image" value="<?=$doctor->image?>"  id="imageu157" class="form-control" required/></a>
				</div>
				</div>
				
				
			<div class="modal-footer"> <a href="<?=base_url()?>doctor/" class="btn btn-default"><?=lang('back')?></a> 
