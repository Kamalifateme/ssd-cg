...
<section class="vbox"> <section class="scrollable padder">
	...
	<section class="panel">
			<?php
			if (!empty($mali_details)) {
			foreach ($mali_details as $key => $mali) { ?>
			<?php
			...
			<header class="panel-heading"> <i class="fa fa-pencil"></i>ویرایش مالی</header>
				...
				<div class="col-lg-12">
					<input type="text" class="form-control"  name="name" value="<?=$mali->name?>"   required >
				</div>
				</div>
				...
				<div class="col-lg-12">
				<textarea name="description" class="form-control editor"><?=$mali->description?></textarea>
				</div>
				</div>
				...
				<div class="col-lg-12">
					<input type="text" class="form-control"  name="url"  value="<?=$mali->url?>"  required >
				</div>
				</div>
                ...
                <input type="text" name="image"  id="imageu157" class="form-control" value="<?=$mali->image?>" /></a>
				</div>
				</div>
                ...
                <input type="text" name="file"  id="imageu159" class="form-control" value="<?=$mali->file?>" /></a>
				</div>
				</div>		
