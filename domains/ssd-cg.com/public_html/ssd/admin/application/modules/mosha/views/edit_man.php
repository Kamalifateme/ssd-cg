...
<section class="vbox"> <section class="scrollable padder">
	...
	<section class="panel">
			<?php
			if (!empty($man_details)) {
			foreach ($man_details as $key => $man) { ?>
			<?php
			...
			<header class="panel-heading"> <i class="fa fa-pencil"></i>ویرایش بهبود عملکرد</header>
				...
				<div class="col-lg-12">
					<input type="text" class="form-control"  name="name" value="<?=$man->name?>"   required >
				</div>
				</div>
				...
				<div class="col-lg-12">
				<textarea name="description" class="form-control editor"><?=$man->description?></textarea>
				</div>
				</div>
				...
				<div class="col-lg-12">
					<input type="text" class="form-control"  name="url"  value="<?=$man->url?>"  required >
				</div>
				</div>
                ...
                <input type="text" name="image"  id="imageu157" class="form-control" value="<?=$man->image?>" /></a>
				</div>
				</div>
                ...
                <input type="text" name="file"  id="imageu159" class="form-control" value="<?=$man->file?>" /></a>
				</div>
				</div>		
