...
<div class="row">
  <div class="col-lg-12">
    <section class="panel">
      ...
      <blockquote class="small text-muted"><?=Applib::get_table_field(Applib::$projects_table,array('project_id'=>$project_id),'description')?></blockquote>
      <!-- End details -->
    </div>
  </section>
</div>
...
<tbody>
  <?php
  $tasks = Applib::retrieve(Applib::$tasks_table,array('project'=>$project_id,'task_progress <'=> 100),$limit = 5);
  if (!empty($tasks)) {
...
<tbody>
<?php
$bugs = Applib::retrieve(Applib::$bugs_table,array('project'=>$project_id),$limit = 5);
if (!empty($bugs)) {
