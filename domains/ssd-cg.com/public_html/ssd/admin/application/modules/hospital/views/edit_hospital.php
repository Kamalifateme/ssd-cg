...
<section class="vbox"> <section class="scrollable padder">
	<ul class="breadcrumb no-border no-radius b-b b-light pull-in ">
		...
		<li class="active">
		<a href="<?=base_url()?>edit_hospital"><?=lang('update_hospital')?>
		</a>
		</li>
	</ul>
	...
	<section class="panel">
			...
			<header class="panel-heading"> <i class="fa fa-navicon"></i> <?=lang('update_hospital')?> </header>
						<?php
				if (!empty($hospitals)) {
			...
			<?php 
             ...
             echo form_open(base_url().'hospital/edit_hospital',$attributes); ?>
				...
				<div class="col-lg-12">
					<input type="text" class="form-control" value="<?=$hospital->name?>"  name="name"    required >
				</div>
				</div>
				...
				<div class="col-lg-12">
					<input type="text" class="form-control" value="<?=$hospital->url?>"  name="url"    required >
				</div>
				</div>
				...
				<div class="col-lg-12">
					...
					<?php
					$query = $this->db->query("select * from fx_city");
                ...
                <input type="text" name="image" value="<?=$hospital->image?>"  id="imageu157" class="form-control" required/></a>
				</div>
				</div>
