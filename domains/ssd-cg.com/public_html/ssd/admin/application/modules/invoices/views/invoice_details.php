				...
				<div class="col-xs-6">
                    <strong><?=$lang2['received_from']?>:</strong>
                        <?php $l = $this->applib->company_details($inv->client,'language'); ?>
                            <h4><?=(config_item('company_legal_name_'.$l) ? config_item('company_legal_name_'.$l) : config_item('company_legal_name'))?>
                            </h4>
                                <p>
                                ...
                                <span class="col-xs-3 no-gutter"><?=$lang2['phone']?> 2:</span><a href="tel:<?=config_item('company_phone_2')?>"><?=config_item('company_phone_2')?></a><br>
                                <?php endif; ?>
                    ...
                    <span class="col-xs-3 no-gutter"><?=$lang2['phone']?>: </span><a href="tel:<?=$phone?>"><?=$phone?></a><br>
                     <span class="col-xs-3 no-gutter"><?=$lang2['company_vat']?>:</span><?=$this->applib->company_details($inv->client,'VAT')?> <br>                      
										</p>
									</div>
								</div>
							</div>
