                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <label class="switch">
                                    ...
                                    <input type="checkbox" <?php if(config_item('use_postmark') == 'TRUE'){ echo "checked=\"checked\""; } ?> name="use_postmark">
                                    <span></span>
                                </label>
                                <span class="help-block m-b-none"><strong><?=lang('portmark_help_text')?></strong></span>
                            </div>
                        </div>
                        <div class="form-group">
