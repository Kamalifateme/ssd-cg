	...
	<div class="table-responsive">
			...
			<thead>
				...
				<tr>
					...
					if($descrs->title==2){echo "استراتژی و بازاریابی"; } 
					if($descrs->title==3){echo "بهبود عملکرد"; } 
					if($descrs->title==4){echo "تکنولوژی نوین اطلاعات"; } 
					if($descrs->title==5){echo "رهبری کسب و کار و دارایی ها"; } 
					if($descrs->title==6){echo "تکنولوژی و شبکه های اجتماعی"; } 
					if($descrs->title==7){echo "استراتژی رشد"; } 
					if($descrs->title==8){echo "ssd(آموزش)"; } 
					if($descrs->title==9){echo "سازمان"; } 
					if($descrs->title==10){echo "مجله کارآفرینی"; } 
					if($descrs->title==11){echo "گالری تصاویر"; } 
					if($descrs->title==12){echo "آموزش آنلاین"; } 
