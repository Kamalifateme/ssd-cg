...
<section class="vbox"> <section class="scrollable padder">
	<ul class="breadcrumb no-border no-radius b-b b-light pull-in ">
		...
		<li class="active">
		<a href="<?=base_url()?>add_about"><?=lang('insert_about')?>
		</a>
		</li>
	</ul>
	...
	<section class="panel">
				 ...
				 ?>
			<header class="panel-heading"> <i class="fa fa-navicon"></i> <?=lang('insert_about')?> </header>
			<?php 
						 $attributes = array('class' => 'bs-example form-horizontal');
             echo form_open(base_url().'about/add_about',$attributes); ?>
