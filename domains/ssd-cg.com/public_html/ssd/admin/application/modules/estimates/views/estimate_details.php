                        ...
                        <div class="well m-t">
                            <div class="row">
                                <div class="col-xs-6">
                                    ...
                                    <h4><?=(!empty($this->config->item('company_legal_name_'.$l)) ? $this->config->item('company_legal_name_'.$l) : $this->config->item('company_legal_name'))?></h4>
                                    <p><?=(!empty($this->config->item('company_address_'.$l)) ? $this->config->item('company_address_'.$l) : $this->config->item('company_address'))?><br>
                                        <?=(!empty($this->config->item('company_city_'.$l)) ? $this->config->item('company_city_'.$l) : $this->config->item('company_city'))?>
                                        <?php if (!empty($this->config->item('company_zip_code'))) : ?>
                                            , <?=$this->config->item('company_zip_code')?>
                                        <?php endif; ?>
                                        <br>
                                        <?=(!empty($this->config->item('company_country_'.$l)) ? $this->config->item('company_country_'.$l) : $this->config->item('company_country'))?><br>
                                        ...
                                        <?php if (!empty($this->config->item('company_phone_2'))) : ?>
