...
<section class="vbox"> <section class="scrollable padder">
	<ul class="breadcrumb no-border no-radius b-b b-light pull-in ">
		...
		<li class="active">
		<a href="<?=base_url()?>work/edit_entre">ویرایش کارآفرینی
		</a>
		</li>
	</ul>
	...
	<section class="panel">
			<?php
			if (!empty($entre_details)) {
			foreach ($entre_details as $key => $entre) { ?>
			<?php
			 $attributes = array('class' => 'bs-example form-horizontal');
             echo form_open(base_url().'work/edit_entre',$attributes); ?>
			 
			 
			<header class="panel-heading"> <i class="fa fa-pencil"></i>ویرایش کارآفرینی</header>
				...
				<div class="col-lg-12">
					<input type="text" class="form-control"  name="name" value="<?=$entre->name?>"   required >
				</div>
				</div>
				...
				<div class="col-lg-12">
				<textarea name="description" class="form-control editor"><?=$entre->description?></textarea>
				</div>
				</div>
				...
				<div class="col-lg-12">
					<input type="text" class="form-control"  name="url"  value="<?=$entre->url?>"  required >
				</div>
				</div>
                ...
                <input type="text" name="image"  id="imageu157" class="form-control" value="<?=$entre->image?>" /></a>
				</div>
				</div>
                ...
                <input type="text" name="file"  id="imageu159" class="form-control" value="<?=$entre->file?>" /></a>
				</div>
				</div>		
