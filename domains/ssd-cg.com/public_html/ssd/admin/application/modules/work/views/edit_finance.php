...
<section class="vbox"> <section class="scrollable padder">
	<ul class="breadcrumb no-border no-radius b-b b-light pull-in ">
		...
		<li class="active">
		<a href="<?=base_url()?>work/edit_finance">ویرایش مالی
		</a>
		</li>
	</ul>
	...
	<section class="panel">
			...
			foreach ($finance_details as $key => $finance) { ?>
			<?php
			 $attributes = array('class' => 'bs-example form-horizontal');
             echo form_open(base_url().'work/edit_finance',$attributes); ?>
			...
			<header class="panel-heading"> <i class="fa fa-pencil"></i>ویرایش مالی</header>
				...
				<div class="col-lg-12">
				<textarea name="description" class="form-control editor"><?=$finance->description?></textarea>
				</div>
				</div>
				...
				<div class="col-lg-12">
					<input type="text" class="form-control"  name="url"  value="<?=$finance->url?>"  required >
				</div>
				</div>
                ...
                <input type="text" name="image"  id="imageu157" class="form-control" value="<?=$finance->image?>" /></a>
				</div>
				</div>
                ...
                <input type="text" name="file"  id="imageu159" class="form-control" value="<?=$finance->file?>" /></a>
				</div>
				</div>		
