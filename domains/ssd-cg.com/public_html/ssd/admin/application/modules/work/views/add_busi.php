...
<section class="vbox"> <section class="scrollable padder">
	<ul class="breadcrumb no-border no-radius b-b b-light pull-in ">
		...
		<li class="active">
		<a href="<?=base_url()?>work/add_busi">اضافه کردن شروع یک کسب و کار
		</a>
		</li>
	</ul>
	...
	<section class="panel">
				 ...
				 ?>
			<header class="panel-heading"> <i class="fa fa-navicon"></i>اضافه کردن شروع یک کسب و کار</header>
			<?php 
						 $attributes = array('class' => 'bs-example form-horizontal');
             echo form_open(base_url().'work/add_busi',$attributes); ?>
