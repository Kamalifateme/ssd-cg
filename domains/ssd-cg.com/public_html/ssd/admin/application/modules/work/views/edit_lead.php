...
<section class="vbox"> <section class="scrollable padder">
	<ul class="breadcrumb no-border no-radius b-b b-light pull-in ">
		...
		<li class="active">
		<a href="<?=base_url()?>work/edit_lead">ویرایش رهبری
		</a>
		</li>
	</ul>
	...
	<section class="panel">
			...
			<?php
             ...
             echo form_open(base_url().'work/edit_lead',$attributes); ?>
			...
			<header class="panel-heading"> <i class="fa fa-pencil"></i>ویرایش رهبری</header>
				...
				<div class="col-lg-12">
				<textarea name="description" class="form-control editor"><?=$lead->description?></textarea>
				</div>
				</div>
				...
				<div class="col-lg-12">
					<input type="text" class="form-control"  name="url"  value="<?=$lead->url?>"  required >
				</div>
				</div>
                ...
                <input type="text" name="image"  id="imageu157" class="form-control" value="<?=$lead->image?>" /></a>
				</div>
				</div>
                ...
                <input type="text" name="file"  id="imageu159" class="form-control" value="<?=$lead->file?>" /></a>
				</div>
				</div>		
