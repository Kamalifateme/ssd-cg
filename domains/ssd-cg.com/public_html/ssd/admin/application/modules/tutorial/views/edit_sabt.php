...
<section class="vbox"> <section class="scrollable padder">
	...
	<section class="panel">
			...
			<header class="panel-heading"> <i class="fa fa-pencil"></i>ویرایش آموزش آنلاین</header>
                ...
                <input type="text" name="file"  id="imageu159" class="form-control" value="<?=$sabts->file?>" /></a>
				</div>
				</div>
                ...
                <input type="text" name="image"  id="imageu158" value="<?=$sabts->image?>" class="form-control" /></a>
				</div>
				</div>
