...
<head>
	...
	<meta name="description" content="سازمان ها تازمانی که برای بقاء تلاش می کنند وخودرانیازمند حضور درعرصه ملی وجهانی می دانند، بایداصل بهبود مستمرراسرلوحه فعالیت خودقراردهند. این اصل حاصل نمی شود، مگراینکه زمینه دستیابی به آن با بهبود رضایت عملکرد امکان پذیری شود. این بهبود رامی توان باگرفت بازخورلازم ازمحیط درون وبیرون سازمان بدست آورد. بازخورددرونی سازمانی نمایانگر سرمایه فکری سازمان است وبازخوربرونی سازمانی نمایانگر سرمایه اجتماعی سازمان است که باتجزیه وتحلیل نقاظ قوت وضعف وایجاد وبکارگیری سیستم ارزیابی عملکرد می توان دربهبودعملکرد سازمان قدم برداشت." />
	<meta property="og:locale" content="fa_IR" />
<meta property="og:type" content="website" />
<meta property="og:title" content="بهبود عملکرد در شرکت سیمرغ صنعت و دانش ssd" />
<meta property="og:description" content="سازمان ها تازمانی که برای بقاء تلاش می کنند وخودرانیازمند حضور درعرصه ملی وجهانی می دانند، بایداصل بهبود مستمرراسرلوحه فعالیت خودقراردهند. این اصل حاصل نمی شود، مگراینکه زمینه دستیابی به آن با بهبود رضایت عملکرد امکان پذیری شود. این بهبود رامی توان باگرفت بازخورلازم ازمحیط درون وبیرون سازمان بدست آورد. بازخورددرونی سازمانی نمایانگر سرمایه فکری سازمان است وبازخوربرونی سازمانی نمایانگر سرمایه اجتماعی سازمان است که باتجزیه وتحلیل نقاظ قوت وضعف وایجاد وبکارگیری سیستم ارزیابی عملکرد می توان دربهبودعملکرد سازمان قدم برداشت." />
<meta property="og:image" content="../ssd/menu/mod1.png" />
<meta property="og:site_name" content="ssd_cg" />
<meta name="telegram:description" content="سازمان ها تازمانی که برای بقاء تلاش می کنند وخودرانیازمند حضور درعرصه ملی وجهانی می دانند، بایداصل بهبود مستمرراسرلوحه فعالیت خودقراردهند. این اصل حاصل نمی شود، مگراینکه زمینه دستیابی به آن با بهبود رضایت عملکرد امکان پذیری شود. این بهبود رامی توان باگرفت بازخورلازم ازمحیط درون وبیرون سازمان بدست آورد. بازخورددرونی سازمانی نمایانگر سرمایه فکری سازمان است وبازخوربرونی سازمانی نمایانگر سرمایه اجتماعی سازمان است که باتجزیه وتحلیل نقاظ قوت وضعف وایجاد وبکارگیری سیستم ارزیابی عملکرد می توان دربهبودعملکرد سازمان قدم برداشت." />
<meta name="telegram:title" content="بهبود عملکرد در شرکت سیمرغ صنعت و دانش ssd" />
<meta name="instagram:description" content="سازمان ها تازمانی که برای بقاء تلاش می کنند وخودرانیازمند حضور درعرصه ملی وجهانی می دانند، بایداصل بهبود مستمرراسرلوحه فعالیت خودقراردهند. این اصل حاصل نمی شود، مگراینکه زمینه دستیابی به آن با بهبود رضایت عملکرد امکان پذیری شود. این بهبود رامی توان باگرفت بازخورلازم ازمحیط درون وبیرون سازمان بدست آورد. بازخورددرونی سازمانی نمایانگر سرمایه فکری سازمان است وبازخوربرونی سازمانی نمایانگر سرمایه اجتماعی سازمان است که باتجزیه وتحلیل نقاظ قوت وضعف وایجاد وبکارگیری سیستم ارزیابی عملکرد می توان دربهبودعملکرد سازمان قدم برداشت." />
<meta name="instagram:title" content="بهبود عملکرد در شرکت سیمرغ صنعت و دانش ssd" />
	<?php include("top.php"); ?>
...
<div class="container">
	...
	<div itemscope itemtype="http://schema.org/headline" itemprop="headSite" class="entry-content" >
		<?php include("tophead.php"); ?>
				...
				<h1 title="بهبود عملکرد" style="direction:rtl;text-align:center;">بهبود عملکرد</h1>
				<?php
			...
			<ul class="grid effect-2" id="grid" style="margin-top:20px;border-bottom:1px #bbb dotted;">
				...
				mysql_query("SET CHARACTER SET utf8");   
				mysql_query("SET NAMES utf8_persian_ci");
				$ses_sql=mysql_query("select * from  fx_man order by viwe DESC ") or die(mysql_error()) ;
				for($i=0;$i<3;$i++)
				{
		...
		<?php
				...
				mysql_query("SET CHARACTER SET utf8");   
				mysql_query("SET NAMES utf8_persian_ci");
				$ses_sql=mysql_query("select * from  fx_man order by id DESC ") or die(mysql_error()) ;
		...
		<div class="cols-2"  style="margin-top:30px;margin-bottom:30px;text-align:justify;direction:rtl;border-bottom:1px #bbb dotted;">
            ...
            <a itemscope itemtype="http://schema.org/url" itemprop="describecourse" href="<?php echo $path; ?>management/<?php echo $url; ?>" style="padding:5px;font-weight:bold;font-size:26px"  onmouseover="this.style.textDecoration='underline'" 
