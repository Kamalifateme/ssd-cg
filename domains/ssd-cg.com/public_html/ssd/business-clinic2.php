...
<br><br>
												<a href="<?php echo $path; ?>business-clinic" style="font-size:13pt;display:block;border-radius:6px;border:2px #fff solid;width:320px;text-align:center;padding:5px;">بازگشت به صفحه تکنولوژی و شبکه های اجتماعی</a><br>
				...
				<span style="font-size:14pt;font-family:BTraffic"><?php echo $description; ?></span><br>
								<?php if($image==""){}else { ?>
								<img src="<?php echo $image; ?>" style="borer-radius:7px;width:320px;height:auto;border:5px #fff solid;" />
				<?php } ?>
				<br>
								<?php if($file==""){}else { ?>
