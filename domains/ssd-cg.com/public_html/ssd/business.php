...
<div class="container">
	...
	<div itemscope itemtype="http://schema.org/WebSite" itemprop="itemprop="isPartOf"" class="entry-content" >
		<?php include("tophead.php"); ?>

	

		<div itemscope itemtype="http://schema.org/WebSite" itemprop="hasPart" class="cols-1" style="margin-top:30px;text-align:justify;direction:rtl;">
		...
		<div class="col">
				...
				$ssd=$row['description'];
				?>
			 <span  itemscope itemtype="http://schema.org/WebSite" itemprop="hasPart" style="font-family:BTraffic;font-size:14pt;color:#ffffff;text-align:justify;direction:rtl;"><?php echo $ssd; ?></span>
