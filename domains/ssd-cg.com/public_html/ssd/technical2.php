...
<br><br>
												<a href="<?php echo $path; ?>technical" style="font-size:13pt;display:block;border-radius:6px;border:2px #fff solid;width:200px;text-align:center;padding:5px;">بازگشت به صفحه تکنولوژی نوین اطلاعات</a><br>
