...
class modbt_loginHelper
{
	...
	function fetchHead($params){
		...
		// load js
		if(file_exists(JPATH_BASE.DS.'templates'.DS.$template.DS.'html'.DS.'mod_bt_login'.DS.'js'.DS.'default.js'))
		{	
			if($loadJquery)
			{ 
		...
		// load css
		if(file_exists(JPATH_BASE.DS.'templates'.DS.$template.DS.'html'.DS.'mod_bt_login'.DS.'css'.DS.'style2.0.css'))
		{
