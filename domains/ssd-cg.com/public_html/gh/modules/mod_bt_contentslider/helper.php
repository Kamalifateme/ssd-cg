...
{
	require_once dirname(__FILE__).DS.'classes'.DS.'images.php';
...
class modBtContentSliderHelper {	
	...
	public static function getList( &$params, $module ){
		...
		$path = dirname(__FILE__).DS."classes".DS.$source.".php";
		//echo $path;
		//die();
	...
	function fetchHead($params){
		...
		$document->addScript(JURI::root().'modules/mod_bt_contentslider/tmpl/js/slides.min.jquery.js');	
