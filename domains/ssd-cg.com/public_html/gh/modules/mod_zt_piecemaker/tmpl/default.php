...
<script type="text/javascript">
	...
	swfobject.embedSWF("<?php echo $urlBase; ?>modules/mod_zt_piecemaker/piecemaker.swf", "jv_piecemaker<?php echo $module->id;?>", "<?php echo $modWidth+50; ?>", "<?php echo $modHeight+50; ?>", "10", "$swfExpress", flashvars, attributes);	
</script>
<div class="jv_piecemaker_wrap">
<div id="jv_piecemaker<?php echo $module->id;?>">
      <p>In order to view this object you need Flash Player 9+ support!</p>
	   <a href="http://www.zootemplate.com/Joomla/templates-showcase.html" title="joomla templates">joomla templates</a> and <a href="http://www.zootemplate.com/joomla-extensions.html" title="joomla extensions">joomla extensions</a> by zootemplate.com
