...
<div id="btl">
	...
	<div class="btl-panel">
		...
		<?php else : ?>
			<!-- Login button -->
			<div class="box-login">
			<span id="btl-panel-login" class="<?php echo $effect;?>"><?php echo JText::_('ورود');?></span>
			...
			?>
			<span id="btl-panel-registration" class="<?php echo $effect;?>"><?php echo JText::_('ثبت نام');?></span>
			<?php }
			} ?>
			</div>
	...
	<div id="btl-content">
		...
		<div id="btl-content-registration" class="btl-content-block">			
			...
			<?php }else{ ?>
				<h3><?php echo JText::_("ثبت نام"); ?></h3>
