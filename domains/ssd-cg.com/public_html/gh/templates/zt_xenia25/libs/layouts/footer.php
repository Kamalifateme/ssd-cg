...
<div id="option_wrapper" style="left:-197px;top:0px;">
	<div class="inner">
			<?php			
				$cookies = array();
			...
			<div class="rb-items clearfix">
				<input type="button" onclick="javascript: onResetDefault(['<?php echo implode($cookies, '\',\'');?>']);" value="تنظیم مجدد" class="rb-reset" />
			</div>
	</div>
</div>
