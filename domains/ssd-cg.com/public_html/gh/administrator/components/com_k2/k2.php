<?php
/**
 * @version		$Id: k2.php 1907 2013-02-08 20:02:08Z joomlaworks $
 * @package		K2
...
// CSS
$document->addStyleSheet(JURI::root(true).'/media/k2/assets/css/k2.css?v=2.6.5');
...
$document->addScript(JURI::root(true).'/media/k2/assets/js/k2.js?v=2.6.5');
...
<div id="k2AdminFooter">
	<a target="_blank" href="http://getk2.org/">K2 v2.6.5</a> | Copyright &copy; 2006-<?php echo date('Y'); ?> <a target="_blank" href="http://www.joomlaworks.net/">JoomlaWorks Ltd.</a>
    | Localize and jalali date by <a target="_blank" href="http://www.joomiran.org/">JoomIran Group</a>
</div>
<?php endif;
