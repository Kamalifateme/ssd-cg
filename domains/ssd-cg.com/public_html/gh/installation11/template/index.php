...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $this->language; ?>" lang="<?php echo $this->language; ?>" dir="<?php echo $this->direction; ?>" >
	...
	<body>
		<div id="header">
			<span class="logo"><a href="http://www.joomlafarsi.com" target="_blank"><img src="template/images/logo.png" alt="Joomla!" /></a></span>
			<h1 ><?php echo JText::_('INSTL_INSTALLATION') ?> جوملا! <?php echo JVERSION; ?> </h1>
		</div>
