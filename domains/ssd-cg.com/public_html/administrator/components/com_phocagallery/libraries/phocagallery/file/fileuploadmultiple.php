...
class PhocaGalleryFileUploadMultiple
{
	...
	static public function renderMultipleUploadLibraries() {
		...
		$document->addScript(JURI::root(true).'/components/com_phocagallery/assets/plupload/plupload.min.js');
		if ($uploadMethod == 2) {
			$document->addScript(JURI::root(true).'/components/com_phocagallery/assets/plupload/plupload.gears.min.js');
		}
		if ($uploadMethod == 3) {
			$document->addScript(JURI::root(true).'/components/com_phocagallery/assets/plupload/plupload.silverlight.min.js');
		}
		if ($uploadMethod == 1) {
			$document->addScript(JURI::root(true).'/components/com_phocagallery/assets/plupload/plupload.flash.min.js');
		}
		if ($uploadMethod == 5) {
			$document->addScript(JURI::root(true).'/components/com_phocagallery/assets/plupload/plupload.browserplus.min.js');
		}
		if ($uploadMethod == 6) {
			$document->addScript(JURI::root(true).'/components/com_phocagallery/assets/plupload/plupload.html4.min.js');
		}
		if ($uploadMethod == 4) {
			$document->addScript(JURI::root(true).'/components/com_phocagallery/assets/plupload/plupload.html5.min.js');
		}
		$document->addScript(JURI::root(true).'/components/com_phocagallery/assets/plupload/jquery.plupload.queue.min.js');
		JHTML::stylesheet( 'components/com_phocagallery/assets/plupload/css/plupload.queue.css' );
	}
