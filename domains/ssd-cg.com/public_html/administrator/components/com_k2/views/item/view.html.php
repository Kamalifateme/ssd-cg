 ...
 * @package		K2
 * @author		JoomlaWorks http://www.joomlaworks.net - jalali date by joomiran.org
...
class K2ViewItem extends K2View
{
    ...
    function display($tpl = null)
    {
		...
		$k2language = JFactory::getLanguage();
		if($k2language->get('tag') == 'fa-IR') {
     		   $document->addScript(JURI::root(true).'/administrator/components/com_k2/views/item/jalaliDate.js');
		}
